...
\begin{frame}[t]{Organisatorisches}
	...
	\begin{block}{\LaTeX\ flavour}
		Die Inhalte dieses Kurses beziehen sich auf die (relativ moderne) \LaTeX-Variante \hologo{XeLaTeX}.
	\end{block}
\end{frame}
...
\item[Alignment] justiﬁed (“Blocksatz”)
\item[Left and right margin] \SI{3}{\centi\meter}
\end{description}
\quoted{\itshape Guidelines for Bachelor theses}
\end{fancyquote}
\endgroup
\end{frame}
...
\end{lstlisting}
\item in \TeX live verfügbare Schriften sind im „\LaTeX\ Font Catalogue“ zu finden\\
\url{http://www.tug.dk/FontCatalogue/}
\qrcorner{http://www.tug.dk/FontCatalogue/}
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Mehrere Bilder in einer Abbildung}
\begin{lstlisting}
