...
\begin{frame}<handout:0>[t]{Organisatorisches}%{Allgemeines}
	\begin{block}<1->{Termine}
		\begin{itemize}
			\item	zwei Sitzungen:
				\begin{itemize}
				\kursAB{
					\item Samstag 15. Februar (heute)
					\item Sonntag 16. Februar (morgen)
				}{
					\item Samstag 8. März (heute)
					\item Sonntag 9. März (morgen)
				}
				\end{itemize}
	...
	\begin{block}<2>{Materialien}
		\begin{columns}
			\column{.7\textwidth}
				\begin{itemize}
					\item Alle Materialien stehen auf der \href{https://ma.latexkurs.de}{Workshophomepage} oder im \href{https://ilias.uni-mannheim.de/goto.php?target=fold_1589856&client_id=ILIAS}{ILIAS} zum Download:\\[1ex]
...
%				\vspace{1ex}
	...
	\begin{block}{Materialien}
		\begin{columns}
			\column{.7\textwidth}
				\begin{itemize}
					\item Alle Materialien stehen auf der \href{https://ma.latexkurs.de}{Workshophomepage} oder im \href{https://ilias.uni-mannheim.de/goto.php?target=fold_1589856&client_id=ILIAS}{ILIAS}
					 zum Download:\\[1ex]
